...
class Parcelas_service:
    ...
    def update_parcelas(
        ...
        return self.dao.update_parcelas_by_id(
            id=id,
            numero_emprestimo=numero_emprestimos,
            valor=valor,
            data=data,
            pagamento=pagamento,
    ...
    def add_numero_emprestimos(self, id):
        return self.dao.add_numero_emprestimo(id=id)
    ...
    def delete_parcela(self, id: int):
        return self.dao.delete_parcela(id=id)
